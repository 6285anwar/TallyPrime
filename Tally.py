...
def home():
    ...
    b10 = Button(top, text="Trial Balance", command=trialbalance, activeforeground="black", activebackground="#ffbe23",
                 fg='black', bg='#a9ceeb', borderwidth=0, font=('Calibri  12')).place(relx=0.551, rely=0.440, relwidth=.148)
    b11 = Button(top, text="Day Book", activeforeground="black", activebackground="#ffbe23", fg='black',
                 bg='#a9ceeb', borderwidth=0, font=('Calibri  12')).place(relx=0.551, rely=0.480, relwidth=.148)
    b12 = Button(top, text="Cash Flow", activeforeground="black", activebackground="#ffbe23", fg='black',
                 bg='#a9ceeb', borderwidth=0, font=('Calibri  12')).place(relx=0.551, rely=0.520, relwidth=.148)
    b13 = Button(top, text="Funds Flow", activeforeground="black", activebackground="#ffbe23", fg='black',
                 bg='#a9ceeb', borderwidth=0, font=('Calibri  12')).place(relx=0.551, rely=0.560, relwidth=.148)
    ...
    def groupsummry(a):
        ...
        def ledgermonthlysummary(b):
            ...
            def ledgervouchers(c):
                ...
                selected_ledgers_frame = Frame(
                    top, bg="white", relief=RAISED, bd=0)
                selected_ledgers_frame.place(x=1, y=73, width=1219, height=604)

                f11 = Frame(selected_ledgers_frame,
                            bg="white", relief=RAISED, bd=0.5)
                f11.grid(row=1, column=0, columnspan=3, ipadx=410, ipady=5)
                l1f1 = Label(f11, text="    Ledger :", font=("Arial", 11), fg="black",
                             bg="white", anchor="w", borderwidth=0, relief=GROOVE, width=44, height=1)
                ...
                l1f2 = Label(f111, text=" Ledger name", font=(
                    "Arial", 10, "bold"), bg="white", fg="black",)
                l1f2.place(x=40, y=10, anchor="center")

                l1f2 = Label(top, text="April 1-2020 to April 1-2021",
                ...
                style = ttk.Style()
                style.configure(".", rowheight=20, font=(
                    'Helvetica', 8), foreground="red")
                ...
                tlv.bind('<Double-1>',)
                tlv.insert("", "end", values=(
                    "1-Apr-22", "Capital Account", "credit", "45676", "546.00", "56546.00"))

                tlv.pack()

                f18 = Frame(selected_ledgers_frame,
                            bg="white", relief=RAISED, bd=1)
                f18.place(x=0, y=544, width=1220, height=60)
                l5f6 = Label(f18, text=" Opening Balance :", font=(
                    "Arial", 9), bg="white", fg="black", borderwidth=0)
                l5f6.place(x=970, y=0,)
                l5f6s = Label(f18, text=" 4564545.00", font=(
                    "Arial", 9, "bold"), bg="white", fg="black", borderwidth=0)
                l5f6s.place(x=1100, y=0,)

                l5f7 = Label(f18, text="        Current Tottal :", font=(
                    "Arial", 9), bg="white", fg="black", borderwidth=0)
                l5f7.place(x=970, y=18,)
                l5f7s = Label(f18, text=" 1000.00", font=(
                    "Arial", 9, "bold"), bg="white", fg="black", borderwidth=0)
                l5f7s.place(x=1100, y=18,)

                separator = ttk.Separator(f18, orient='horizontal')
                separator.place(relx=0.01, rely=0.60,
                                relheight=0, relwidth=0.980)

                l5f8 = Label(f18, text="Closing Balance :", font=(
                    "Arial", 10, "bold"), bg="white", fg="black", borderwidth=0)
                l5f8.place(x=965, y=38,)
                l5f8s = Label(f18, text=" 1000.00", font=(
                    "Arial", 10, "bold"), bg="white", fg="black", borderwidth=0)
                l5f8s.place(x=1100, y=38,)
            ...
            f11 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=0.5)
            f11.grid(row=1, column=0, columnspan=3, ipadx=410, ipady=5)
            l1f1 = Label(f11, text="    P e r t i c u l a r s", font=("Arial", 11), fg="black",
                         bg="white", anchor="w", borderwidth=0, relief=GROOVE, width=5, height=4)
            l1f1.pack(fill=X, pady=2, padx=2)

            f12 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=0.5)
            f12.place(x=873, y=0, width=346, height=40)
            l1f2 = Label(f12, text="ledger Name", font=(
                "Arial", 8, "italic"), bg="white", fg="black")
            l1f2.place(x=175, y=7, anchor="center")
            l1f2 = Label(f12, text="Company Name", font=(
                "Arial", 8, "bold"), bg="white", fg="black")
            l1f2.place(x=100, y=25, anchor="center")
            l1f3 = Label(f12, text="For 1-1-1235",
                         font=("Arial", 8), bg="white", fg="black")
            l1f3.place(x=200, y=25, anchor="w")

            f111 = Frame(selected_ledgers_frame,
                         bg="white", relief=RAISED, bd=0.5)
            f111.place(x=873, y=40, width=241, height=23)
            l1f2 = Label(f111, text="Transactions", font=(
                "Arial", 9, "bold"), bg="white", fg="black",)
            l1f2.place(x=120, y=9, anchor="center")

            f14 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=1)
            f14.place(x=873, y=63, width=120, height=23)
            l1f5 = Label(f14, text="Debit", font=(
                "Arial", 9), bg="white", fg="black")
            l1f5.place(x=40, y=10, anchor="w")
            f15 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=1)
            f15.place(x=994, y=63, width=120, height=23)
            l2f5 = Label(f15, text="Credit", font=(
                "Arial", 9), bg="white", fg="black")
            l2f5.place(x=40, y=10, anchor="w")

            f15a = Frame(selected_ledgers_frame,
                         bg="white", relief=RAISED, bd=1)
            ...
            frame = Frame(selected_ledgers_frame.master,
                          width=845, height=100, bd=0)
            ...
            tableledgermonthlysummary = ttk.Treeview(
                frame, columns=("size", "modified"))
            tableledgermonthlysummary["columns"] = (
                "Perticulars", "Debit", "Credit", "Closing Balance")
            ...
            tableledgermonthlysummary.insert("", "end", values=(
                "April", "45676.00", "45676.00", "45676.00"))
            tableledgermonthlysummary.insert(
                "", "end", values=("May", "7844.00", "4567637"))
            tableledgermonthlysummary.insert(
                "", "end", values=("June", "85246.00", "74185.00"))
            tableledgermonthlysummary.insert("", "end", values=(
                "July", "45676.00", "45676.00", "45676.00"))
            tableledgermonthlysummary.insert(
                "", "end", values=("August", "7844.00", "4567637"))
            tableledgermonthlysummary.insert(
                "", "end", values=("September", "85246.00", "74185.00"))
            tableledgermonthlysummary.insert(
                "", "end", values=("October", "85246.00", "74185.00"))
            tableledgermonthlysummary.insert("", "end", values=(
                "November", "45676.00", "45676.00", "45676.00"))
            tableledgermonthlysummary.insert(
                "", "end", values=("December", "7844.00", "4567637"))
            tableledgermonthlysummary.insert(
                "", "end", values=("January", "85246.00", "74185.00"))
            tableledgermonthlysummary.insert(
                "", "end", values=("February", "7844.00", "4567637"))
            tableledgermonthlysummary.insert(
                "", "end", values=("March", "85246.00", "74185.00"))
            tableledgermonthlysummary.grid()

            f18 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=1)
            f18.place(x=0, y=398, width=874, height=20)
            l5f6 = Label(f18, text=" G r a n d  T o t a l", font=(
                "Arial", 10, "bold"), bg="white", fg="black", borderwidth=0)
            l5f6.place(x=0, y=0, anchor="nw")

            f19 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=1)
            f19.place(x=874, y=398, width=120, height=20)
            l6f6 = Label(f19, text="544650.00", font=(
                "Arial", 10, "bold"), bg="white", fg="black", borderwidth=0)
            l6f6.place(x=0, y=0, anchor="nw")

            f20 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=1)
            f20.place(x=994, y=398, width=120, height=20)
            l7f6 = Label(f20, text="544650.00", font=(
                "Arial", 10, "bold"), bg="white", fg="black", borderwidth=0)
            l7f6.place(x=0, y=0, anchor="nw")

            f21 = Frame(selected_ledgers_frame,
                        bg="white", relief=RAISED, bd=1)
            f21.place(x=1114, y=398, width=104, height=20)
            l7f6 = Label(f21, text="452650.00", font=(
                "Arial", 10, "bold"), bg="white", fg="black", borderwidth=0)
            l7f6.place(x=0, y=0, anchor="nw")
        ...
        l1f1 = Label(f11, text="    P e r t i c u l a r s", font=("Arial", 11), fg="black",
                     bg="white", anchor="w", borderwidth=0, relief=GROOVE, width=10, height=4)
        l1f1.pack(fill=X, pady=2, padx=2)
        ...
        l1f2 = Label(f12, text="Company Name", font=(
            "Arial", 9, "bold"), bg="white", fg="black")
        l1f2.place(x=120, y=9, anchor="center")
        l1f3 = Label(f12, text="1-1-1235", font=("Arial", 8),
                     bg="white", fg="black")
        ...
        l1f2 = Label(f111, text="Closing Balance", font=(
            "Arial", 9, "bold"), bg="white", fg="black",)
        l1f2.place(x=120, y=9, anchor="center")
        ...
        tablegroupsummry.insert("", "end", values=(
            "Capital Account under Ledger1", "", "45676.00"))
        ...
        l5f6 = Label(f18, text=" G r a n d  T o t a l", font=(
            "Arial", 11, "bold"), bg="white", fg="black", borderwidth=0)
        l5f6.place(x=0, y=0, anchor="nw")
        f19 = Frame(selected_ledgers_frame, bg="white", relief=RAISED, bd=1)
        f19.place(x=978, y=579, width=120, height=25)
        l6f6 = Label(f19, text="-------", font=("Arial", 11, "bold"),
                     bg="white", fg="black", borderwidth=0)
        l6f6.place(x=0, y=0, anchor="nw")
        f20 = Frame(selected_ledgers_frame, bg="white", relief=RAISED, bd=1)
        f20.place(x=1099, y=579, width=120, height=25)
        l7f6 = Label(f20, text="456460.00", font=(
            "Arial", 11, "bold"), bg="white", fg="black", borderwidth=0)
        l7f6.place(x=0, y=0, anchor="nw")
        #   End Group summry
...
# side buttons
    ...
    tabletrialbalance.insert("", "end", values=(
        "Capital Account", "6746.00", "45676.00"))
    tabletrialbalance.insert("", "end", values=(
        "Current Liabilities", "7844.00", "4567637"))
    tabletrialbalance.insert("", "end", values=(
        "Current Assets", "85246.00", "74185.00"))
    ...
    b8s = Label(top, text="Differnce in opening balance", activeforeground="black", activebackground="#ffbe23",
                fg='black', bg='white', borderwidth=0, font=('Arial  9 italic'), anchor="w")
    b8s.place(x=0, y=630, width=980, height=18)
    l3f6 = Label(f16, text="741424.00", font=(
        "Arial", 10), bg="white", fg="black")
    l3f6.place(x=0, y=410, anchor="nw")
    l4f6 = Label(f17, text="12146560.00", font=(
        "Arial", 10), bg="white", fg="black")
    ...
    f19 = Frame(selected_ledgers_frame, bg="white", relief=RAISED, bd=1)
    f19.place(x=978, y=579, width=120, height=25)
    l6f6 = Label(f19, text="544650.00", font=("Arial", 11, "bold"),
                 bg="white", fg="black", borderwidth=0)
    l6f6.place(x=0, y=0, anchor="nw")
    f20 = Frame(selected_ledgers_frame, bg="white", relief=RAISED, bd=1)
    f20.place(x=1099, y=579, width=120, height=25)
    l7f6 = Label(f20, text="544650.00", font=("Arial", 11, "bold"),
                 bg="white", fg="black", borderwidth=0)
    l7f6.place(x=0, y=0, anchor="nw")
